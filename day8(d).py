...
# To specify that comma is the delimiter, use string.split(','). For this challenge, and in general on HackerRank, 
...
# Task
# Given  sets of integers,  and , print their symmetric difference in ascending order. The term symmetric
# difference indicates those values that exist in either  or  but do not exist in both.
