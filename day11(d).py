...
# not participate in the process. He numbered all his friends with integers from 1 to n. Petya remembered that a friend number i gave a gift
# to a friend number pi. He also remembered that each of his friends received exactly one gift.

# Now Petya wants to know for each friend i the number of a friend who has given him a gift.

# Input
# The first line contains one integer n (1 ≤ n ≤ 100) — the quantity of friends Petya invited to the party. 
# The second line contains n space-separated integers: the i-th number is pi — the number of a friend who gave a gift 
