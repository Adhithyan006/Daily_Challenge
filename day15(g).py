# Hackerrank Qn name: Company Logo 
...
# Both a and c occur  times. So, a is printed in the second line and c in the third line because a comes 
...
if __name__ == '__main__':
    s = input().strip()
    freq = Counter(s)
    # Sort by (-count, character) to get descending count and alphabetical order for ties
