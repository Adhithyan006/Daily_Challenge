# Codeforces Qn: 381A. Sereja and Dima 
...
# 16 12
# Note
# In the first sample Sereja will take cards with numbers 10 and 2, so Sereja's sum is 12. Dima will take cards with numbers 4 and 1,
# so Dima's sum is 5.
