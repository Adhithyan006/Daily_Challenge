# Codeforces Qn: 1676A. Lucky? 
# A ticket is a string consisting of six digits. A ticket is considered lucky if the sum of the first three digits is equal to the sum of the last three digits. Given a ticket, output if it is lucky or not.
...
# Output
# Output t
#  lines, each of which contains the answer to the corresponding test case. 
...
#  and the sum of the last three digits is 8+9+4=21, they are not equal so the answer is "NO".
# In the third test case, the sum of the first three digits is 0+4+5=9
#  and the sum of the last three digits is 2+0+7=9, they are equal so the answer is "YES".
